      ...
      <div className='outer-box'>
        ...
        <form onSubmit={() => handleSubmit()} className='sublet-form'>
          ...
          <div className="form-group">
            ...
            <input type='text' id="street2" placeholder='Optional' />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type='text' id="apartment" placeholder='Apartment? or Condominium...' />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type='text' id="price" placeholder='For how long?' />
          </div>
          <div className="form-group">
